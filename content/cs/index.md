...
- [[content/cs/architecture/cpu|cpu]] (중앙처리장치): 연산과 제어의 중심으로, 컴퓨터의 '두뇌'에 해당한다.
    - [[content/cs/architecture/cpu#CPU 구성요소|주요 구성 요소]]
...
네트워크 Network. 인터넷이나 어떤 통신에 있어서 그물처럼 연결된 환경을 네트워크라고 한다. 기기와 기기 사이의 통신인데, 노드(기기)와 간선(통신 매체)으로 연결된 그래프와 동일한 형태를 띈다.  
